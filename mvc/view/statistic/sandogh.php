<?
if (getaces(6) == 0 && $_SESSION['level']!=0 && $_SESSION['level']!=1) {
    exit;
}
?>
        ...
        <div class="row mt-5">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row"></span>تعداد کل وام های پرداخت شده<span class="spanDescription"></th>
...
<script>
    ...
    function fillPageTable(data) {
        ...
        data.forEach(element => {
            ...
            $("<td class='removetd'><a class='removebtn' onclick=removeRecord(" + grec + ") data-bs-toggle='modal' data-bs-target='#RemoveModal' href='#'><i class='bi bi-trash'></i></a></td>").insertAfter($('tbody tr th:nth(4)'));
        });
    }
